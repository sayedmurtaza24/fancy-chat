...
function Home() {
  ...
  const logs = useSelector(state => state.logs.logsList);
    ...
    <div className="home-page">
      ...
      <div className="home-page__contents">
        <nav className="home-page__nav">
          <button className={"nav__btn " + (showLogs ? 'nav__btn--active' : '')} onClick={() => setShowLogs(true)}>
          ...
          <button className={"nav__btn " + (!showLogs ? 'nav__btn--active' : '')} onClick={() => setShowLogs(false)}>
            <svg className="svg-icon" width="20" height="20" fill="none" viewBox="0 0 24 24">
